            ...
            for game in games:
                ...
                if game[1] is not None:
                    if game[1] > 0:  # home_team_ats
                        team_wins[game[0]] = team_wins.get(game[0], 0) + 1
                    else:
                        team_losses[game[0]] = team_losses.get(game[0], 0) + 1

                if game[3] is not None:
                    if game[3] > 0:  # away_team_ats
                        team_wins[game[2]] = team_wins.get(game[2], 0) + 1
                    else:
                        team_losses[game[2]] = team_losses.get(game[2], 0) + 1
