...
CREATE TABLE Standings_Message_2022 (
...
ALTER TABLE Players
ADD COLUMN 2022_registration tinyint unsigned   DEFAULT NULL;

ALTER TABLE Players
ADD COLUMN 2022_paid tinyint unsigned   DEFAULT NULL;
