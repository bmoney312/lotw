...
CREATE TABLE Standings_Message_2024 (
...
ALTER TABLE Players
ADD COLUMN 2024_registration tinyint unsigned   DEFAULT NULL;

ALTER TABLE Players
ADD COLUMN 2024_paid tinyint unsigned   DEFAULT NULL;
