...
CREATE TABLE Standings_Message_2026 (
...
ALTER TABLE Players
ADD COLUMN 2026_registration tinyint unsigned   DEFAULT NULL;

ALTER TABLE Players
ADD COLUMN 2026_paid tinyint unsigned   DEFAULT NULL;
