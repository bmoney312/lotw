...
CREATE TABLE Standings_Message_2025 (
...
ALTER TABLE Players
ADD COLUMN 2025_registration tinyint unsigned   DEFAULT NULL;

ALTER TABLE Players
ADD COLUMN 2025_paid tinyint unsigned   DEFAULT NULL;
